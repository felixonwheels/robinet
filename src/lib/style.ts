...
export const styleLight: StyleSpecification = {
	version: 8,
	sources: {
		protomaps: {
			type: 'vector',
			...
			url: 'pmtiles://https://r2.robinet.app/world11.pmtiles'
		}
	},
	layers: [
		{
...
export const styleDark: StyleSpecification = {
	version: 8,
	sources: {
		protomaps: {
			type: 'vector',
	...
	layers: [
		...
		},
		{
			...
			paint: {
				'line-color': ['interpolate', ['exponential', 1.6], ['zoom'], 11, '#292929', 16, '#1f1f1f'],
				'line-width': [
					'interpolate',
					['exponential', 1.6],
					['zoom'],
